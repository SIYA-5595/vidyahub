      ...
      <div className="flex-1 lg:pl-72 flex flex-col">
        ...
        <main className="flex-1 p-6 md:p-10 space-y-8">
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
            <div>
              <h1 className="text-4xl font-black italic tracking-tighter text-slate-900 uppercase">User Registry</h1>
            ...
            <div className="flex items-center gap-3">
              <button 
                ...
                className="flex items-center gap-2 h-12 px-4 bg-white border border-slate-200 rounded-xl text-slate-600 font-black text-[10px] uppercase tracking-widest hover:bg-slate-50 transition-colors shadow-sm disabled:opacity-50"
              ...
              <button 
                ...
                className="flex items-center gap-2 h-12 px-6 bg-primary text-white rounded-xl font-black text-[10px] uppercase tracking-widest shadow-xl shadow-primary/20 hover:opacity-90 transition-opacity"
              >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
            {[
              { label: "Total Registrations", value: loading ? "..." : totalUsers, trend: "Nexus Bound", color: "text-blue-600" },
              { label: "Elevated Access", value: loading ? "..." : adminCount, trend: "Admin Nodes", color: "text-emerald-600" },
              { label: "Restricted Nodes", value: loading ? "..." : blockedCount, trend: "Protocol 4", color: "text-rose-600" },
            ].map((stat, i) => (
              <div key={i} className="p-6 bg-white rounded-[2rem] border border-slate-200/60 shadow-sm flex flex-col gap-1 transition-all hover:shadow-md">
