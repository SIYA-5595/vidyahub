    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
      {stats.map((stat, i) => (
        <div 
          ...
          className="p-8 rounded-[2.5rem] bg-white border border-secondary/10 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-500 group overflow-hidden relative cursor-pointer active:scale-95"
        >
          ...
          <div className="flex items-center justify-between mb-8 relative z-10">
            <div className={`p-4 rounded-2xl ${stat.light}`}>
